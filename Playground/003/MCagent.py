...
class MineRLAgent:
    ...
    def get_action(self, minerl_obs):
        ...
        agent_action, self.hidden_state, probs_and_v = self.policy.act(
    ...
    #     pd, value = self.policy.v(self._env_obs_to_agent(obs), self._dummy_first, self.hidden_state)
    ...
    def get_logprob_and_value(self, obs, action = None):
        ...
        return action, log_prob, value, minerl_action 
