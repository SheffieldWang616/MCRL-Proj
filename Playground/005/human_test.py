...
# MLG_WATER_ENTRY_POINT = "minerl.herobraine.env_specs.mlg:_mlg_water_gym_entrypoint"  # Update with actual module

# gym.register(
#     id="MLGWater-v0",
#     entry_point=MLG_WATER_ENTRY_POINT,
...
# env = MLG.make()
# from minerl.herobraine.env_specs.tree import TreeEnvSpec
# Tree = TreeEnvSpec()
# env = Tree.make()
...
for i in range(samples):
    ...
    # env = gym.make('MineRLEquipWeapon-v0')
    ...
    try:
        while not done:
            ...
            cum_reward += reward
            print("+++++++++++ Reward is :", cum_reward, done, "+++++++++++")
